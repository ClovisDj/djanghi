...
class TestPasswordResetPage:
    ...
    def test_cannot_retrieve_non_existing_password_reset_link_page(self, active_abc_user_password_reset_link):
        response = self.client.get(
            self.url.format(
                association_id=str(active_abc_user_password_reset_link.association.id),
                user_id=str(active_abc_user_password_reset_link.user_id),
    ...
    def test_cannot_retrieve_password_reset_link_for_non_existing_association(self,
                                                                              active_abc_user_password_reset_link):
        response = self.client.get(
            self.url.format(
    ...
    def test_cannot_retrieve_password_reset_link_for_malformed_association_id(self,
                                                                              active_abc_user_password_reset_link):
        response = self.client.get(
            self.url.format(
                association_id='unw5vn-ewfmnf-0jm45-HGvdt4',
                user_id=str(active_abc_user_password_reset_link.user_id),
                link_id=str(active_abc_user_password_reset_link.id),
            )
        )
    ...
    def test_user_can_reset_password_with_valid_password_reset_link(self, active_abc_user_password_reset_link):
        ...
        assert len(mail.outbox) == 1    # The outgoing email generated by active_abc_user_password_reset_link creation
